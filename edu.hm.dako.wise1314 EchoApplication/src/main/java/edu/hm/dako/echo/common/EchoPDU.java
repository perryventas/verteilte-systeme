...
public class EchoPDU implements Serializable
{
  ...
  private String clientName; // Name des Client-Threads, der den Request
                             // absendet
  private String serverThreadName; // Name des Threads, der den Request im
                                   // Server bearbeitet
  ...
  private String clientThreadName; // Dieses Kennzeichen dient dem Server dazu,
                                   // um festzustellen,
  // ob sich der Client nach der Nachricht beendet
  private long serverTime; // Zeit in Nanosekunden, die der Server benoetigt.
                           // Diese

...
public final class ServerFactory
{
  ...
  public static EchoServer getServer(
      UserInterfaceInputParameters.ImplementationType type ) throws Exception
  {
    ...
    switch ( type )
    {
      case TCPSingleThreaded:
        return new DefaultEchoServerImpl(
            Executors.newSingleThreadExecutor(),
            getDecoratedServerSocket( new TcpServerSocket( DEFAULT_SERVER_PORT ) ),
            false );
  ...
  private static ServerSocket getDecoratedServerSocket(
  ...
  public static void main( String[] args ) throws Exception
  {
    ...
    /* Hinweis: Im ImplementationType der naechsten Anweisungen muss der Server,
     * der gestartet werden soll, angegeben werden, hier nur TCPSingleThreaded
     * und TCPMultiThreaded implementiert */
    getServer(

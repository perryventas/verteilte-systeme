 ...
 * Umschliesst eine beliebige Connection-Instanz und bietet dieselbe
 * Schnittstelle an. Beim Aufruf einer Methode wird zunaechst eine Log-Ausgabe
 * getaetigt und danach die Methode der umschlossenen Connection aufgerufen.

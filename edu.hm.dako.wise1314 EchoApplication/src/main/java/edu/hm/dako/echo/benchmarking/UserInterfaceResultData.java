...
public class UserInterfaceResultData
{
  ...
  private long numberOfLostResponses; // Anzahl verlorener (nicht empfangener)
                                      // Responses
  ...
  private long maxHeapSize; // Maximale Heap-Belegung waehrend des Testlaufs in
                            // MByte
  private float maxCpuUsage; // Maximale CPU-Auslastung waehrend des Testlaufs
                             // in Prozent

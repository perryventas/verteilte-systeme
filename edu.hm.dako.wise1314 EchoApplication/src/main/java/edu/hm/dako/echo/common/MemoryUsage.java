...
/**
 * Klasse common Testklasse fuer einen Heap-Test. Klasse dient nur zum Test und
 * ist nicht nicht fuer die Studienarbeit relevant
 * 
 * @author mandl
 */
public class MemoryUsage
{
  ...
  public static void printFreeMemory()
  {
    ...
    System.out.println( "Maximaler moeglicher Heap-Speicher: "
        + n.format( inMBytes( r.maxMemory() ) ) + " MB, "
        + "benutzter Heap-Speicher: " + n.format( inMBytes( usedMemory( r ) ) )
        + " MB, " + "noch verfuegbar insgesamt: "

...
public class tibjmsQueueReceiver
{
  ...
  public tibjmsQueueReceiver( String serverUrl, String userName,
      String password, String queueName )
  {
    this.serverUrl = null;
    this.userName = null;
    this.password = null;
    this.queueName = "queue.sample";

    tibjmsQueueReceiverShowMonitor( serverUrl, userName, password, queueName );
  }
  ...
  public void tibjmsQueueReceiverShowMonitor( String serverUrl,
  ...
  void usage()
  {
    ...
    System.err
        .println( "  -queue     <queue-name> - queue name, default is \"queue.sample\"" );

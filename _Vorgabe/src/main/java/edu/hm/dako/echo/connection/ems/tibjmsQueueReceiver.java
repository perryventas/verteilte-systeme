...
public class tibjmsQueueReceiver
{
    ...
    public tibjmsQueueReceiver(String serverUrl, String userName, String password, String queueName) {
        this.serverUrl       = null;
        this.userName        = null;
        this.password        = null;
    ...
    public tibjmsQueueReceiver(String[] args) {
     ...
     public void tibjmsQueueReceiverShowMonitor(String serverUrl, String userName, String password, String queueName)
     {
